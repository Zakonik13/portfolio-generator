...
// Refactored the code to chain .filter() and .map() together.
// Same result as commented code below this function
...
// One way to use .filter to filter user input based on boolean value, then interpolate into HTML
// const generateProjects = projectsArr => {
